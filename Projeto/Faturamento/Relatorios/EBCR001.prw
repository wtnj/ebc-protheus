...
PutSX1(cPerg , "05" , "Serie           ?" , "" , "" , "mv_ch5"  , "N" , 1 						, 0 , 0 , "C" , "", "   "	, "", "", "mv_par05" , "REC" ,"","","","DEB" , "   " , "" , "" , "" , "" , "" , "" , "" , "" , "" , "" )
PutSX1(cPerg , "06" , "Cliente de      ?" , "" , "" , "mv_ch6"  , "C" , TAMSX3("F2_CLIENTE")[1] , 0 , 0 , "G" , "", "SA1"	, "", "", "mv_par06" , "      " ,"","","","      " , "   " , "" , "" , "" , "" , "" , "" , "" , "" , "" , "" )
PutSX1(cPerg , "07" , "Cliente Até     ?" , "" , "" , "mv_ch7"  , "C" , TAMSX3("F2_CLIENTE")[1] , 0 , 0 , "G" , "", "SA1"	, "", "", "mv_par07" , "      " ,"","","","      " , "   " , "" , "" , "" , "" , "" , "" , "" , "" , "" , "" )
PutSX1(cPerg , "08" , "Via             ?" , "" , "" , "mv_ch8"  , "N" , 1 						, 0 , 0 , "C" , "", "   "	, "", "", "mv_par08" , "1a Via" ,"","","","2a Via" , "   " , "" , "" , "" , "" , "" , "" , "" , "" , "" , "" )
...
cQry += "AND F2_SERIE = '" + cSerie + "'" +c_ent

//cQry += "AND F2_SERIE BETWEEN '" + cSerie + "' AND '" + cSerie + "' " +c_ent

cQry += "AND F2_CLIENTE BETWEEN '" + mv_par06 + "' AND '" + mv_par07 + "' " + c_ent
...
cQry += "GROUP BY F2_EMISSAO, F2_DOC, F2_SERIE,F2_VALMERC,F2_DESCONT,F2_VALIRRF,F2_VALINSS,F2_VALCOFI,F2_VALPIS,F2_VALCSLL,F2_VALISS,F2_COND,D2_CF,D2_ALQIRRF,D2_ALIQINS,D2_ALQCSL,D2_ALQPIS,D2_ALQCOF,D2_ALIQISS,C5_NUM,C5_CLIENTE,C5_LOJACLI,C5_MENNOTA,C5_MENPAD,A1_NOME,A1_END,A1_BAIRRO,A1_CEP,A1_MUN,A1_EST,A1_CGC,A1_INSCR,A1_INSCRM,A1_TEL,A1_FAX,A1_EMAIL,D2_COD,D2_PRCVEN,D2_TOTAL " + c_ent
...
If !(cAlias)->(EOF())
	...
	While !(cAlias)->(EOF())
		...
		oPrn:SayBitmap(0120, 0480, "Logo_"+Substr(cFilAnt,1,2)+"_Baixa.jpg", 0385, 0150)
		dbSelectArea("SM0")
		SM0->(dbSetOrder(1))
		nRecno := SM0->(Recno())
		...
		If cSerie = "DEB"
			...
			oPrn:Say(0060,1460,"NOTA DEBITO",oFntCur10B,,,,0)
			
		ElseIf cSerie = "REC"
			
			oPrn:Say(0060,1460,"NOTA LOCAÇÃO",oFntCur10B,,,,0)
		...
		If cSerie = "DEB"
			...
			oPrn:Say(0420,1460,"NATUREZA DA OPERAÇÃO: NOTA DE DEBITO",oFntCur08B,,,,0)
			
		ElseIf cSerie = "REC"
			
			oPrn:Say(0420,1460,"NATUREZA DA OPERAÇÃO: LOCAÇÃO DE BENS",oFntCur08B,,,,0)
		...
		*--------------------------------------------*
		...
		If cSerie = "DEB"
			...
			oPrn:Say(0630,0550,"NOTA DE DEBITO",oFntCur10B,,,,0)
			
		ElseIf cSerie = "REC"
			
			oPrn:Say(0630,0550,"NOTA DE LOCAÇÃO",oFntCur10B,,,,0)
		...
		/*
		oPrn:Box(0900, 0455, 1080, 1900)
		oPrn:Say(0945,0470,"DESCONTO DE:",oFntCur10B,,,,0)
		oPrn:Say(0945,1550,"ATÉ:",oFntCur10B,,,,0)
		oPrn:Say(0990,0470,"CONDIÇÕES ESPECIAIS:",oFntCur10B,,,,0)
		oPrn:Box(0720, 1900, 1080, 2250)
		oPrn:Say(0750,1910,"PARA USO DA INSTITUIÇÃO",oFntCur06B,,,,0)
		oPrn:Say(0810,2000,"FINANCEIRA",oFntCur06B,,,,0)
		*/
		...
		ELSEIf cSerie = "REC"
			...
			oPrn:Say(0810,0970,"DESTINATÁRIO DOS EQUIPAMENTOS",oFntCur12B,,,,0)
			oPrn:Say(0870,0470,"NOME LOCATÁRIO: ",oFntCur08B,,,,0)
		...
		If cSerie = "REC"
			oPrn:Say(1590,0470,"PELOS BENS LOCADOS CONSTANTES DA",oFntCur10N,,,,0)
			oPrn:Say(1650,0470,"PRESENTE NOTA DE LOCAÇÃO.",oFntCur10N,,,,0)
		EndIf
		...
		ELSEIf cSerie = "REC"
			...
			oPrn:Say(1850,0450,"DISCRIMINAÇÃO DOS BENS LOCADOS",oFntCur10B,,,,0)
		...
		ELSEIf cSerie = "REC"
			...
			oPrn:Say(1850,1935,"VALOR DA LOCAÇÃO",oFntCur10B,,,,0)
		...
		/*
		For nCont := nContador+1 to 9
		nLinha += 60
		oPrn:Say(nLinha,0100,"Linha "+alltrim(str(ncont)),oFntCur10N,,,,0)
		next
		*/
		...
		*/
		...
		oPrn:Say(2690,1590,"NOTA DE",oFntCur15B,,,,0)
		
		
		If cSerie = "DEB"
			
			oPrn:Say(2750,1590,"DEBITO",oFntCur15B,,,,0)
			
		ELSEIf cSerie = "REC"
			
			oPrn:Say(2750,1590,"LOCAÇÃO",oFntCur15B,,,,0)
		...
		If cSerie = "DEB"
			...
			oPrn:Say(2840,0090,"NOTA DE DEBITO",oFntCur10B,,,,0)
			
		ELSEIf cSerie = "REC"
			
			oPrn:Say(2840,0090,"NOTA DE LOCAÇÃO",oFntCur10B,,,,0)
		...
		ELSEIf cSerie = "REC"
			...
			oPrn:Say(2840,0500,"RECEBI(EMOS) DE "+ ALLTRIM(cNomeEmp) + "., OS BENS CONSTANTES DESTA NOTA DE LOCAÇÃO INDICADA AO LADO.",oFntCur06N,,,,0)
